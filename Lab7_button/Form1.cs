...
namespace Lab7_button
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_SizeChanged(object sender, EventArgs e)
        {
            ...
            //Отступ справа
            if (x_new > this.Width - button1.Width) { x_new = tableLayoutPanel1.Width - button1.Width - 100;  }
            ...
            //Отступ снизу
            if (y_new > this.Height - button1.Height) { y_new = tableLayoutPanel1.Height - button1.Height - 100;  }
